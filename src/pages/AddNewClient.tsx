    ...
    <div className="min-h-screen bg-gray-50 pb-20 add-client-page">
      ...
      <div className="mx-auto add-client-container">
        ...
        <div className="bg-white form-content">
          ...
          {currentTab === 2 && (
            <div className="p-4 sm:p-6 care-requirements-tab space-y-6">
              ...
              <div className="care-requirements__section bg-gray-50 rounded-xl p-4 border border-gray-100">
              ...
              <div className="care-requirements__section bg-white rounded-xl p-4 border border-gray-100">
                <h3 className="text-base font-semibold text-gray-900 mb-4 flex items-center gap-2">
                  <Calendar size={18} />
                  Care Duration
                </h3>
                
                <div className="care-duration__fields grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <Input
              ...
              <div className="care-requirements__section bg-white rounded-xl p-4 border border-gray-100">
                ...
                <div className="care-level__grid grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {CARE_LEVELS.map((level) => (
                    <button
                      key={level.id}
                      onClick={() => handleCareLevel(level.id)}
                      className={`care-level__button p-3 rounded-lg border-2 transition-all duration-200 text-left ${
              ...
              {careRequirements.selectedCareLevel && (
                <div className="care-requirements__section bg-white rounded-xl p-4 border border-gray-100">
                  ...
                  <div className="weekly-schedule__grid grid grid-cols-2 sm:grid-cols-7 gap-2">
                    {careRequirements.weeklySchedule.map((daySchedule, index) => (
                      <div
                        key={daySchedule.day}
                        className={`weekly-schedule__day border rounded-lg p-2 ${
              ...
              <div className="care-requirements__section bg-white rounded-xl p-4 border border-gray-100">
                ...
                <div className="additional-info__fields space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      className="w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors min-h-[100px] placeholder:text-gray-400 text-sm"
